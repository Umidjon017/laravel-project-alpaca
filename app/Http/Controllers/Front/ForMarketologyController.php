...
class ForMarketologyController extends Controller
{
    ...
    public function store(StoreForMarketologyRequest $request)
    {
        ...
        return redirect()->route('admin.main-page.marketology.index')->with('success', 'For marketology added successfully!');
    }
    ...
    public function update(UpdateForMarketologyRequest $request, ForMarketology $marketology)
    {
        ...
        return redirect()->route('admin.main-page.marketology.index')->with('success', 'For marketology edited successfully!');
    }
