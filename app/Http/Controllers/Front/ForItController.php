...
class ForItController extends Controller
{
    ...
    public function store(StoreForItRequest $request)
    {
        ...
        return redirect()->route('it.index')->with('success', 'For IT added successfully!');
    }
    ...
    public function update(UpdateForItRequest $request, ForIt $it)
    {
        ...
        return redirect()->route('it.index')->with('success', 'For IT edited successfully!');
    }
    ...
    public function destroy(ForIt $it)
    {
        ...
        return redirect()->route('it.index')->with('success', 'For IT deleted successfully!');
    }
