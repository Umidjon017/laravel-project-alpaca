                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <div class="card-title">
                                        <h6> Gallery block {{ $loop->iteration }} </h6>
                                        <form action="{{ route('admin.gallery.destroy', $gallery->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm float-end ms-2">Delete</button>
                                        </form>
                                        <button type="button" class="btn btn-success btn-sm float-end text-capitalize" data-bs-toggle="modal" data-bs-target="#editGallery{{$gallery->id}}">Edit</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex">
                                    ...
                                    <div class="card mt-3">
                                        <div class="card-header">
                                            <div class="card-title">
                                                ...
                                                <a href="{{ route('admin.appeals.edit', $appeal->id) }}" class="btn btn-success btn-sm float-end text-capitalize">Edit</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="example">
                                    ...
                                    <div class="card mt-3">
                                        <div class="card-header">
                                            <div class="card-title">
                                                ...
                                                <a href="{{ route('admin.clients.edit', $client->id) }}" class="btn btn-success btn-sm float-end text-capitalize">Edit</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="example">
                                                ...
                                                <div class="me-3">
                                                    <h6 class="mb-1">Logo</h6>
                                                    <img src="{{ asset(clients_file_path().$client->logo) }}" alt="" width="200">
                                                </div>
                                                ...
                                                <div class="me-3">
                                                    <h6 class="mb-1">Image</h6>
                                                    <img src="{{ asset(clients_file_path().$client->image) }}" alt="" width="200">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
